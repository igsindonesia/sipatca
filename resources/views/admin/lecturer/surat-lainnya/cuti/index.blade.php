            ...
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('admin.surat-lainnya-dosen.cuti.preview', $submission->id) }}" target="_blank" class="btn btn-warning">Preview</a>
                    <a href="{{ route('admin.surat-lainnya-dosen.cuti.show', $submission->id) }}" class="btn btn-primary">Detail</a>
                  </td>
                </tr>
                @endforeach
              </table>
