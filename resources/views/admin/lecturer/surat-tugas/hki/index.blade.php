      ...
      <div class="col">
        <div class="card">
          <div class="card-header">
            <h4>Surat Tugas HKI (Hak Cipta)</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('admin.surat-lainnya-dosen.hki.preview', $submission->id) }}" target="_blank" class="btn btn-warning">Preview</a>
                    <a href="{{ route('admin.surat-lainnya-dosen.hki.show', $submission->id) }}" class="btn btn-primary">Detail</a>
                  </td>
                </tr>
                @endforeach
              </table>
